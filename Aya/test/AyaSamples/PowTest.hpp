...
inline void GenerateMRsForPow(const std::function<double(double, double)> &testedFunction,\
    ...
    size_t inputTransformerChainLength, size_t outputTransformerChainLength,
    ...
    Aya::CalculateMRScore<double, double, double, double>(
        static_cast<std::function<double(double, double)>>(testedFunction), comparer, finalMRs, validationInputs, 0, 0);
